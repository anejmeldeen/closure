...
export default function SettingsPage() {
  ...
  const handleGoogleDisconnect = async () => {
    ...
    const confirmDisconnect = window.confirm(
      "Are you sure you want to disconnect your Google Calendar? You will no longer be able to sync events.",
    );
    ...
    try {
      ...
      if (count === 0) {
        throw new Error(
          "Database blocked the deletion. Please ensure RLS policies allow DELETE.",
        );
      }
                ...
                <section className="paper-texture border-4 border-[#2D2A26] shadow-brutal-lg p-8">
                  ...
                  <div className="space-y-6">
                    <p className="text-xs font-bold uppercase opacity-60 leading-relaxed max-w-xl">
                      Sync your external schedule to automatically block off
                      busy hours in the personnel registry. Your events remain
                      private, and you can manually edit the synced data later.
                    </p>
                        ...
                        <div className="p-5 bg-[#f5f2e8] border-2 border-[#2D2A26] shadow-brutal-sm flex flex-col gap-5">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-[9px] font-bold text-green-700 uppercase tracking-widest mt-0.5">
                                Connected & Active
                              </p>
                            </div>
                          </div>
