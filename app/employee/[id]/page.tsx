...
import { ArrowLeft, Code2, Briefcase, Star, Calendar as CalendarIcon } from "lucide-react";
...
export default function EmployeePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const fetchEmployee = async () => {
      ...
      // Loading from local storage for testing parity with the profile page.
                ...
                <div key={hour} className="grid grid-cols-8">
                  ...
                  {DAYS.map(day => {
                    ...
                    return (
                      <div
                        key={slotKey}
                        className={`border-r-2 border-b-2 border-[#2D2A26] h-8 ${
